...
class mainView: UIViewController, AVAudioPlayerDelegate {
    ...
    override func loadView() {
        ...
        levelLabel.font = UIFont(name: "Arial", size:30)
        levelLabel.textAlignment = .center
        levelLabel.translatesAutoresizingMaskIntoConstraints = false
        self.view.addSubview(levelLabel)
        
        NSLayoutConstraint.activate([
            redButton.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: -100),
            redButton.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: -100),
            redButton.widthAnchor.constraint(equalToConstant: 190),
            redButton.heightAnchor.constraint(equalToConstant: 190),
            
            yellowButton.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 100),
            yellowButton.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: -100),
            yellowButton.widthAnchor.constraint(equalToConstant: 190),
            yellowButton.heightAnchor.constraint(equalToConstant: 190),
            
            greenButton.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: -100),
            greenButton.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: 100),
            greenButton.widthAnchor.constraint(equalToConstant: 190),
            greenButton.heightAnchor.constraint(equalToConstant: 190),
            
            blueButton.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 100),
            blueButton.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: 100),
            blueButton.widthAnchor.constraint(equalToConstant: 190),
            blueButton.heightAnchor.constraint(equalToConstant: 190),
            ...
            startGameButton.heightAnchor.constraint(equalToConstant: 120),
            
            levelLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            levelLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 30),
